...
public class CHabilidades {
    ...
    public ResponseEntity<?> create(@RequestBody DtoHabilidades dtohab){
        ...
        Habilidades habilidades = new Habilidades(dtohab.getNombreH(), dtohab.getNivelH());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoHabilidades dtohab){
       ...
       //Valida si existe id
        ...
        if(StringUtils.isBlank(dtohab.getNivelH()))
            return new ResponseEntity(new Mensaje("El nombre es obligatorio"), HttpStatus.BAD_REQUEST);
        
        Habilidades habilidades = sHabilidades.getOne(id).get();
        habilidades.setNombreH(dtohab.getNombreH());
        habilidades.setNivelH((dtohab.getNivelH()));
